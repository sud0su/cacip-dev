...
THEME_ACCOUNT_CONTACT_EMAIL = os.getenv(
    'THEME_ACCOUNT_CONTACT_EMAIL', 'contact@centralasiaclimateportal.org'
)
...
AUTH_EXEMPT_URLS += (
    ...
    '^/events/\d+$',
    '^/events/$',
    '^/events/h_keywords_api',
    '^/forums/$',
    '^/gs/',
    '^/h_keywords_api',
    '^/i18n/',
    '^/knowledgehub/documents/\d+/metadata_detail$',
    '^/knowledgehub/documents/\d+$',
    '^/knowledgehub/documents/$',
    '^/knowledgehub/documents/h_keywords_api',
    '^/layers/[a-zA-Z0-9:\-_]+/metadata_detail$',
    '^/layers/[a-zA-Z0-9:\-_]+$',
    '^/layers/$',
    '^/layers/h_keywords_api',
    '^/maps/\d+/metadata_detail$',
    '^/maps/\d+$',
    '^/maps/$',
    '^/maps/h_keywords_api',
